...
public class SimpleCharStream {
   ...
   public SimpleCharStream(InputStream var1, int var2, int var3, int var4) {
      this((Reader)(new InputStreamReader(var1)), var2, var3, var4);
   }
